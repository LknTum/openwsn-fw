...
slotinfo_element_t static_schedule_entries[6];
...
void init_slotinfo(){
	...
	static_schedule_entries[0].isUpdated = TRUE;
	...
	static_schedule_entries[1].isUpdated = TRUE;
	...
	static_schedule_entries[2].isUpdated = TRUE;
	...
	static_schedule_entries[3].isUpdated = TRUE;
