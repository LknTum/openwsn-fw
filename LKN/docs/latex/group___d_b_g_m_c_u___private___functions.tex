...
\subsubsection[{\texorpdfstring{D\+B\+G\+M\+C\+U\+\_\+\+Config(uint32\+\_\+t D\+B\+G\+M\+C\+U\+\_\+\+Periph, Functional\+State New\+State)}{DBGMCU_Config(uint32_t DBGMCU_Periph, FunctionalState NewState)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} D\+B\+G\+M\+C\+U\+\_\+\+Config (
