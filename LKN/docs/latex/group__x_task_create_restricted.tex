...
task. h 
\begin{DoxyPre}
 BaseType\_t \hyperlink{task_8h_a61b00cd623953f4f94fe794057d7f648}{xTaskCreateRestricted( TaskParameters\_t *pxTaskDefinition, TaskHandle\_t *pxCreatedTask )};\end{DoxyPre}
...
\begin{DoxyPre}int \hyperlink{projects_2xpressohack_2_open_w_s_n___o_s_2src_2main_8c_a840291bc02cba5474a4cb46a9b9566fe}{main( void )}
\{
...
Memory regions are assigned to a restricted task when the task is created by a call to \hyperlink{task_8h_a61b00cd623953f4f94fe794057d7f648}{x\+Task\+Create\+Restricted()}. These regions can be redefined using \hyperlink{task_8h_ad889595baff9faf9efe02f3696825409}{v\+Task\+Allocate\+M\+P\+U\+Regions()}.
