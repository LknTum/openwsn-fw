...
#IT IS POSSIBLE TO CHANGE SERIAL PORT MANUALLY 
        #serialports = [(s,BAUDRATE_Z1) for s in glob.glob('/dev/ttyS0')]
	serialports = [(s,BAUDRATE_Z1) for s in glob.glob('/dev/ttyUSB[0-9]')]
